	...
	<form action="updatePro.jsp?pageNum=<%=pageNum%>" method="post"> 
		...
		<table class="table">
			<tr>
		      ...
		      <td><input type="text" name="name" value="<%=bb.getName()%>" readonly="readonly"></td>
		    </tr>  
		    <tr>
			...
			<tr>      
		      ...
		      <td colspan="3"><input type="text" name="subject" value="<%=bb.getSubject()%>"></td>
		    </tr>
			<tr>
				<th scope="col">content</th>
				<td colspan="3" rowspan="4"><textarea rows="10" cols="30" name="content" ><%=bb.getContent()%></textarea></td>
			</tr>
